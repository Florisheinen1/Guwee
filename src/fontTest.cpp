...
unsigned int createFontShader(const char* &vertex, const char* &fragment) {
...
int main()
{
	...
	createFontShader(vertexShaderSourceFont, fragmentShaderSourceFont);
	...
	// load font as face
    FT_Face face;
    if (FT_New_Face(ft, "../resources/resources/fonts/arial.ttf", 0, &face)) {
